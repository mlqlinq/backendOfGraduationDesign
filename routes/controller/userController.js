...
router.post("/login", async (ctx) => {
    ...
    if (!data.name || !data.password || !data.userIdentity) {
        ...
        global.userData = {};
        global.userData.username = res.username;
        global.userData.nick_name = res.nick_name;
        global.userData.email = res.email;
        global.userData.phonenumber = res.phonenumber;
        global.userData.avatar = res.avatar;
        global.userData.sex = res.sex;
