...
CREATE TABLE `national_scholarship_application_information`  (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除(0-未删, 1-已删)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '国家助学金申请信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `national_scholarship_application_information` VALUES (15, '广西民族大学相思湖学院', '理工学院', '10000001', '2019-09', '19软工2班', '信息系统与信息管理', '4', '叶浩', '中共预备党员', '460400255221149662', '男', '汉族', '淄博', '4', '13686838348', '[{\"name\":\"1\",\"parentIDNum\":\"2\",\"age\":\"3\",\"call\":\"父亲\",\"currentEducation\":\"义务教育阶段\",\"occupation\":\"学生无业人员(无收入)\",\"wSUnit\":\"4\",\"annualIncome\":\"5\",\"health\":\"良好\",\"healthDescription\":\"6\"}]', '2000', '500', '6403131!7', '城镇户口', '2300', '[\"无其它收入来源\"]', 'liyou ', '{\"desc\":\"情况属实，该生确定是经济困难学生！\",\"resource\":\"0\"}', '{\"desc\":\"情况属实，同意该生审评 一等助学金\",\"resource\":\"0\"}', '{\"desc\":\"经评审，并在校内公示5个工作日，无异议，现报请同意该同学获得国家助学金。\",\"resource\":\"0\"}', '2023-01-19 23:05:50', '2023-02-09 16:43:02', 0);
...
CREATE TABLE `nationalendeavor`  (
  ...
  `is_deleted` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否删除(0-未删, 1-已删)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '国家励志奖学金表单' ROW_FORMAT = Dynamic;
...
INSERT INTO `nationalendeavor` VALUES (22, '广西民族大学相思湖学院', '理工学院', '19软工2班', '10000001', '叶浩', '男', '2022-03-10 00:00:00', '汉族', '2019-09', '13686838348', '信息系统与信息管理', '中共预备党员', '2019级', '460400255221149662', '1', '22', '1', '22', '[\"http://127.0.0.1:4090/uploads/1676536362729.jpg\"]', '0', '奖励', 'liyou ', '{\"desc\":\"2 e\",\"resource\":\"0\"}', '{\"desc\":\"333\",\"resource\":\"0\"}', 'http://127.0.0.1:4090/uploads/1673532325058.jpg', '12', '22', 'q', 'q', 'q', 'q', '淄博q', 'q', '2023-01-15 14:50:52', '2023-02-16 16:40:54', 0);
INSERT INTO `nationalendeavor` VALUES (23, '广西民族大学相思湖学院', '理工学院', '19软工2班', '10000001', '叶浩', '男', '2022-03-10 00:00:00', '汉族', '2019-09', '13686838348', '信息系统与信息管理', '中共预备党员', '2019级', '460400255221149662', '1', '5', '1', '3', '', '0', '曾获何种奖励', '理由', '', '', 'http://127.0.0.1:4090/uploads/1676527585744.jpg', '1', '9', '4', '1000', '隧道', '500', '淄博', '532100', '2023-04-08 00:30:56', '2023-04-08 00:30:56', 0);
...
-- ----------------------------
INSERT INTO `sys_students` VALUES (1, 1, '10000001', '叶浩', '男', '2019-09', '2023-07', '汉族', '2022-03-10', '广西民族大学相思湖学院', '理工学院', '信息系统与信息管理', '工学', '123456', '19软工2班', '中华人民共和国来往港澳通行证', '2班', '460400255221149662', '中共预备党员', '在校生', '13686838348', '4', 'http://127.0.0.1:4090/uploads/1680949015640.jpg', '本科', '定向培养', '全日制', '2019级', '4', '统招', 'huey.smith@hotmail.com', '12321313131', '3213213123', '321321313', '城镇户口', '淄博', '6403131!7', '17140947278', '2023-01-04 21:51:12', '2023-04-08 18:18:30', 0);
